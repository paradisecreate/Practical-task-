...
function addCard(requirement) {
    ...
    // Timestamp shown on the card tag, in EEST (Eastern European Summer Time).
    // Intl with an explicit IANA zone handles the UTC+3 offset correctly.
    const stamp = new Intl.DateTimeFormat('en-GB', {
        timeZone: 'Europe/Riga',
        year: 'numeric', month: '2-digit', day: '2-digit',
        hour: '2-digit', minute: '2-digit', hour12: false
    }).format(new Date()) + ' EEST';

    // Generated by GitHub Copilot
    const card =
`                    <div class="ticket">
                        <span class="ticket-tag">${stamp}</span>
                        <p>${safe}</p>
                    </div>
                    <!-- new-cards -->`;
